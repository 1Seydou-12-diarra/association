...
public class FacadeMembre {
    ...
    public void enregistrerOuModifier(MembreDto membreDto) {
        ...
        if (membre == null) {
            membre = new Membre(membreDto.getId(),membreDto.getNom(),membreDto.getPrenom(), membreDto.getContact(), membreDto.getEmail(), membreDto.getResidence(),
                    StatutMembre.valueOf(membreDto.getStatut()));
        } else {
            membre.mettreAJour(membreDto.getNom(),membreDto.getEmail(), membreDto.getContact(), StatutMembre.valueOf(membreDto.getStatut()));
        }
